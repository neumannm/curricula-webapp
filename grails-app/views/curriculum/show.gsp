...
<html>
    ...
    <body>
        ...
        <div id="show-curriculum" class="content scaffold-show" role="main">
            ...
            <f:display bean="curriculum" />
            <g:form resource="${this.curriculum}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.curriculum}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
